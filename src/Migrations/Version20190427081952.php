 ...
 */
final class Version20190427081952 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE localities (id INT AUTO_INCREMENT NOT NULL, locality VARCHAR(60) NOT NULL, postal_code VARCHAR(6) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
