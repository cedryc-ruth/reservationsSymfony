 ...
 */
final class Version20190614165315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE shows ADD CONSTRAINT FK_6C3BF14412469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
